...
const translations = {
    es: {
        ...
        step2Desc: "Tus datos se guardan al instante en tu navegador (Local Storage). Puedes cerrar o recargar la página sin perder nada.",
    ...
    en: {
        ...
        step2Desc: "Your data is instantly saved in your browser (Local Storage). You can close or reload the page without losing anything.",
    ...
    pt: {
        ...
        step2Desc: "Seus dados são salvos instantaneamente no seu navegador (Local Storage). Você pode fechar ou recarregar a página sem perder nada.",
    ...
    it: {
        ...
        step2Desc: "I tuoi dati vengono salvati istantaneamente nel tuo browser (Local Storage). Puoi chiudere o ricaricare la pagina senza perdere nulla.",
